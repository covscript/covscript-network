...
check_null("O15: trailing-slash base path still forms request URL", r3)
var r4 = client.request("chat/completions", payload)
check_null("O16: endpoint without leading slash is normalized", r4)

section("chat_text with null response")
var result = client.chat_text(null)
check_null("O17: chat_text(null) returns null", result)
