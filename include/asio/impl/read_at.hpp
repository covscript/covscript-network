...
namespace asio {
	...
	async_read_at(AsyncRandomAccessReadDevice
	              & d,
	              uint64_t offset,
	             ...
	             )
	{
		...
		detail::read_at_op<AsyncRandomAccessReadDevice, MutableBufferSequence,
		       CompletionCondition, ASIO_HANDLER_TYPE(ReadHandler,
		               void (asio::error_code, std::size_t))>(
		           d, offset, buffers, completion_condition, init
		           .handler)(
...
// not meet the documented type requirements for a ReadHandler.
		...
		detail::read_at_op<AsyncRandomAccessReadDevice, MutableBufferSequence,
		       detail::transfer_all_t, ASIO_HANDLER_TYPE(ReadHandler,
		               void (asio::error_code, std::size_t))>(
		           d, offset, buffers, transfer_all(), init
		           .handler)(
	...
	async_read_at(AsyncRandomAccessReadDevice
	              & d,
	              uint64_t offset, asio::basic_streambuf<Allocator>
	              & b,
	              CompletionCondition completion_condition,
	              ASIO_MOVE_ARG(ReadHandler) handler)
	{
...
// not meet the documented type requirements for a ReadHandler.
		...
		detail::read_at_streambuf_op<AsyncRandomAccessReadDevice, Allocator,
		       CompletionCondition, ASIO_HANDLER_TYPE(ReadHandler,
		               void (asio::error_code, std::size_t))>(
		           d, offset, b, completion_condition, init
		           .handler)(
